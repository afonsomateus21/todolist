package br.com.afonsomateus.todolist.task;
...
import br.com.afonsomateus.todolist.exceptions.TaskNotFound;
import br.com.afonsomateus.todolist.utils.Utils;
...
public class TaskController {
  ...
  public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
    ...
    if (currentDate.isAfter(taskModel.getStartAt()) || taskModel.getEndAt().isBefore(taskModel.getStartAt())) {
      return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Datas inicio e(ou) fim inválidas!");
    }
